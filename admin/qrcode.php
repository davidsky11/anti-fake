...
if($act == "qrcode"){
       $qrcodeid = $_GET["id"];
		...
		$sql="select * from tgs_code where id='$qrcodeid' limit 1";
      ...
      <table cellpadding="3" cellspacing="1" class="table_98">
        <tr>
          <td colspan="2" align="left"><div class="formtitle"><span><?php echo $rn?></span></div>
            <input name="editid2" type="hidden" id="qrcodeid" value="<?php echo $qrcodeid?>" /></td>
        </tr>
        <tr >
          <td height="54" colspan="2"><?php    
$value = "$codeurl/qrcode.php?bianhao=$bianhao"; //二维码内容 
...
//输出图片 
imagepng($QR, "qrcodeimg/ew80qrcode.png"); 
echo "<img src='qrcodeimg/ew80qrcode.png'>";  
...
// echo "<img src='qrcodeimg/$bianhao.png'>";  
 ?>
        ...
        <tr >
          <td height="45" colspan="2"><h3>防伪码： <?php echo $bianhao?></h3></td>
        </tr>
        <tr >
          <td height="45" colspan="2"><h3>产品名称： <?php echo $product?></h3></td>
        </tr>
        <tr >
          <td height="45" colspan="2"><h3>所属代理：<?php echo $zd1?></h3></td>
        </tr>
        <tr >
          <td height="48"><h3>销售区域：<?php echo $zd2?></h3></td>
        </tr>
        <tr >
          <td height="45" colspan="2" valign="middle"><h3>产品介绍：<? echo $jianjie?></h3></td>
        </tr>
      </table></td>
  </tr>
</table>
